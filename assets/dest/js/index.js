                ...
                switch (item.format) {
                    case 'jpg':
                        component = _react2.default.createElement('img', {
                            className: _this2.props.imgClassName + ' max-height-100 ' + hide,
                            src: item.src });
                        break;
                    case 'mp4':
                        console.log(item);
                        component = _react2.default.createElement(
                            'video',
                            {
                                ...
                                width: '100%',
                                height: '100%',
                                className: _this2.props.imgClassName + ' object-fit-cover max-height-100 ' + hide },
                    ...
                    case 'svg':
                        component = _react2.default.createElement(
                            'object',
                            {
                                className: _this2.props.imgClassName + ' p0 max-height-100 ' + hide,
                                data: item.src,
                                width: '100%',
                                height: '100%',
                                type: 'image/svg+xml' },
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_carousel2.default, {
                            ...
                            items: [{ src: './assets/dest/images/OB_background-02.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_background-09.mp4', format: 'mp4',
                                opts: {
                                    video: {
                                        muted: true
                                    }
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'z1 bg-white mr4 ml4 mt4 p3 fixed top-0 left-0 right-0 border border-black' },
                        _react2.default.createElement(
                            'div',
                            {
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'z1 bg-white mr4 ml4 mb4 p3 fixed bottom-0 left-0 right-0 border border-black overflow-hidden' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'tr border border-black' },
                            _react2.default.createElement(_carousel2.default, {
                                imgClassName: 'center-carousel-img',
                                className: 'td td-1',
                                interval: 4000,
                                items: [{ src: './assets/dest/images/OB_left-01.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-02.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-03-04.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-05-06.mp4', format: 'mp4' }, { src: './assets/dest/images/OB_left-07.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-08-09.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-10.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-11.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_left-12.svg', format: 'svg' }]
                            }),
                            _react2.default.createElement(_carousel2.default, {
                                imgClassName: 'center-carousel-img',
                                className: 'td td-2',
                                interval: 4000,
                                items: [{ src: './assets/dest/images/OB_right-01.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_right-02-03.mp4', format: 'mp4' }, { src: './assets/dest/images/OB_right-04-05.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_right-06-07.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_right-08.jpg', format: 'jpg' }, { src: './assets/dest/images/OB_right-09-10.svg', format: 'svg' }, { src: './assets/dest/images/OB_right-11-12.jpg', format: 'jpg' }]
                            })
                        )
                    )
                )
